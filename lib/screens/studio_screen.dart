...
class _StudioScreenState extends State<StudioScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _lbl('MODE'),
            Row(children: [
              _modeBtn('✍️  TEXTE → VIDÉO', 'Wan 2.1',
                  GenerationMode.textToVideo),
              const SizedBox(width: 10),
              _modeBtn('🖼️  IMAGE → VIDÉO', 'Wan I2V',
            ...
            Text(
              _mode == GenerationMode.textToVideo
                  ...
                  : '💡 Upload sur imgbb.com → copie le lien direct',
            ...
            if (_mode == GenerationMode.imageToVideo) ...[
              _lbl('URL DE L\'IMAGE'),
              _field(_imageUrlCtrl,
                  hint: 'https://i.ibb.co/xxx/photo.jpg'),
              const SizedBox(height: 8),
              const Text('💡 imgbb.com → upload → copie "Direct link"',
                  style: TextStyle(
                      color: Color(0xFF555555), fontSize: 10)),
              const SizedBox(height: 12),
              _lbl('PROMPT (OPTIONNEL)'),
              _field(_promptCtrl,
  ...
  Widget _modeBtn(String label, String sub,
      GenerationMode mode) {
  ...
  Widget _slide(String label, double value,
